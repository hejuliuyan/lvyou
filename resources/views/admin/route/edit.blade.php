...
@stop
@section('content')
    <form action="/index.php/route_edit_post" name="pic_submit" method="post" enctype="multipart/form-data" onsubmit="return check_city_date();">
        <input type="hidden" name="id" value="{{$list[0]->id}}">
        <div class="result-content" >
            <div class="top-content">
                <div class="pic" >
                    <div class="pic_img" id="localImag"><img id="preview" src="/Uploads/pic/{{$list[0]->picture}}"></div>
                ...
                <table  class="table-content">
                    <tr class="tr-content">
                        ...
                        <td class="td-content">&nbsp;{{$list[0]->code}}</td>
                        <td class="td-content-title">门市价</td>
                        <td class="td-content"><input type="text" class="input" name="rated_price" value="{{$list[0]->rated_price}}"></td>
                    </tr>
                    <tr class="tr-content">
                        <td class="td-content-title">折扣价</td>
                        <td class="td-content"><input type="text" class="input" name="discount_price" value="{{$list[0]->discount_price}}"></td>
                        <td class="td-content-title">游玩方式</td>
                        <td class="td-content">
                            <select class="input" name="play_way" id="">
                                <option @if($list[0]->play_way==1) selected="selected"@endif value="1">品质游</option>
                                <option  @if($list[0]->play_way==2) selected="selected"@endif value="2">跟团游</option>
                            </select>
                        </td>
                    ...
                    <tr class="tr-content">
                        ...
                        <td class="td-content"><input type="text" class="input" placeholder="天数" name="journey_day" value="{{$list[0]->journey_day}}"></td>
                        <td class="td-content-title">交通方式</td>
                        <td class="td-content">
                            <select class="input" name="traffic" id="">
                                @foreach ($list[2] as $traffic)
                                    <option @if($list[0]->traffic ==$traffic->id) selected="selected" @endif value="{{ $traffic->id }}"> {{ $traffic->traffic }} </option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    {{--<tr class="tr-content">--}}
                        ...
                        {{--<td class="td-content">--}}
                            {{--<select class="input" name="start_city" id="">--}}
                                {{--@foreach ($list[4] as $start_city)--}}
                                    {{--<option @if($list[0]->start_city ==$start_city->id) selected="selected" @endif value="{{ $start_city->id }}">{{ $start_city->start_city }}</option>--}}
                                {{--@endforeach--}}
                            {{--</select>--}}
                        {{--</td>--}}
                        {{--<td class="td-content-title">出发日期</td>--}}
                        {{--<td class="td-content"><input type="text" class="input datainp" id="dateinfo" placeholder="请选择"  value="{{ $list[0]->new_start_date }}" name="start_date"></td>--}}
                    {{--</tr>--}}
                    <tr class="tr-content">
                        <td class="td-content-title">产品类别</td>
                        <td class="td-content">
                            <select class="input" name="product_cate" id="">
                                <option @if($list[0]->product_cate==1) selected="selected"@endif value="1">尾单</option>
                                <option @if($list[0]->product_cate==2) selected="selected"@endif value="2">免费</option>
                                <option @if($list[0]->product_cate==3) selected="selected"@endif value="3">精品</option>
                            </select>
                        </td>
                        <td class="td-content-title">目的地</td>
                        <td class="td-content">
                            <select class="input" name="destination" id="">
                                @foreach ($list[3] as $destination)
                                    <option  @if($list[0]->destination ==$destination->id) selected="selected" @endif value="{{ $destination->id }}">{{ $destination->destination }}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    <tr class="tr-content">
                        ...
                        <td class="td-content">
                            <select class="input" name="route_cate" id="">
                                <option @if($list[0]->route_cate==1) selected="selected" @endif value="1">周边游</option>
                                <option @if($list[0]->route_cate==2) selected="selected" @endif value="2">国内游</option>
                                <option @if($list[0]->route_cate==3) selected="selected" @endif value="3">出境游</option>
                            </select>
                        </td>
                        <td class="td-content-title">线路标签</td>
                        <td class="td-content">
                            <select class="input" name="route_label" id="">
                                @foreach ($list[1] as $route_label)
                                    <option  @if($list[0]->route_label ==$route_label->id) selected="selected" @endif value="{{ $route_label->id }}">{{ $route_label->route_label }}</option>
                                @endforeach
                            </select>
                    ...
                    <tr class="tr-content">
                        ...
                        <td class="td-content">
                            <select class="input" name="seventy_allow" id="">
                                <option @if($list[0]->seventy_allow==1) selected="selected" @endif value="1">可选</option>
                                <option  @if($list[0]->seventy_allow==2) selected="selected" @endif value="2">不可选</option>
                            </select>
                        </td>
                        <td class="td-content-title">扣卡次数</td>
                        <td class="td-content">
                            <input type="text" class="input" name="require_num" value="{{$list[0]->require_num}}" onkeyup="value=this.value.replace(/\D+/g,'')">
                        </td>
                    </tr>
                    {{--<tr class="tr-content">--}}
                        {{--<td class="td-content-title">成团人数</td>--}}
                        {{--<td class="td-content"><input type="text" class="input" name="cluster_num" placeholder="成团人数" value="{{$list[0]->cluster_num}}"></td>--}}
                        {{--<td class="td-content-title"></td>--}}
                        {{--<td class="td-content"></td>--}}
                    {{--</tr>--}}
                    <tr class="tr-content-last">
                        <td class="td-content-title">线路名称</td>
                        <td class="td-content"><textarea class="input" maxlength="30" placeholder="不超过30个字符" name="route_name"  >{{ $list[0]->route_name }}</textarea></td>
                        <td class="td-content-title">线路提示</td>
                        <td class="td-content"><textarea class="input" maxlength="25" placeholder="不超过25个字符" name="route_prompt">{{ $list[0]->route_prompt }} </textarea></td>
                    </tr>
                </table>
            </div>
            {{--出发城市和日期--}}
            <div class="mid-content">
                <div class="start_city">
                    <div class="select_city">
                        ...
                        <div class="select_city_content" id="{{$list[4][0]->id}}">{{$list[4][0]->start_city}}
                            {{--<select class="input" name="start_city" id="">--}}
                    ...
                    <div class="add_address_border">
                        <div class="add_address_input"><input type="text" class="input_address"name="input_address" placeholder="请输入具体地址(必填)"></div>
                    ...
                    <div class="specific_address">
                        @if(!empty($list[5]))
                        @foreach ($list[5] as $start_city_place)
                            <div class='input_address_p'><span class='input_address_val' id="{{$start_city_place->start_city_id}}">{{$start_city_place->start_city_place}}</span><span class='delete'>&nbsp;X</span></div>
                        @endforeach
                        @endif
                    </div>
                </div>
                <div class="start_date">
                    <div class='rows c_schedule'>
                        ...
                        <input type="hidden" name="event-data" value="{{$list[6]}}">
            ...
            <div class="bot-content">
                ...
                <div class="bot-content-ue">
                    <!-- 加载编辑器的容器 -->
                    <input type="hidden" name="route_journey" value="{{ $list[0]->route_journey }}">
                    <input type="hidden" name="cost_explain" value="{{ $list[0]->cost_explain }}">
                    <input type="hidden" name="schedule_guide" value="{{ $list[0]->schedule_guide }}">
        ...
        <div class="event-inner">
            <div class="add-new">
                <div  class="event-place">
                    <select  class="event-place-select" name="event-place" placeholder="选择出发地点" value="" maxlength="100">
...
////                okfun:function(val){alert(val)}把format年月去掉
//            });
//        });
        {{--ue1.ready(function() {--}}
            {{--//设置编辑器的内容--}}
            {{--ue.setContent({{ $list[0]->route_journey }});--}}
        {{--});--}}
